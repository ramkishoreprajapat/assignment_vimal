...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(4278850891),
      ...
      onPrimaryFixed: Color(4278850891),
  ...
  static const customColor = ExtendedColor(
    seed: Color(4293576787),
    value: Color(4293576787),
    light: ColorFamily(
      color: Color(4285619213),
      onColor: Color(4294967295),
      colorContainer: Color(4294828422),
      onColorContainer: Color(4280490752),
    ),
    ...
    dark: ColorFamily(
      color: Color(4292920685),
      onColor: Color(4282134272),
      colorContainer: Color(4283843840),
      onColorContainer: Color(4294828422),
    ),
